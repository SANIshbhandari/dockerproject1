...
<div class="form-container">
    ...
    <div class="animal-profile">
        ...
        <div class="profile-info">
            ...
            <div class="info-item">
                ...
                <value><?php echo $animal['quantity'] ?? 0; ?></value>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                <label>Status</label>
                <value><span class="badge badge-<?php echo $animal['status'] ?? 'active'; ?>"><?php echo ucfirst($animal['status'] ?? 'active'); ?></span></value>
            </div>
            <?php if (!empty($animal['current_location'])): ?>
            <div class="info-item">
                <label>Location</label>
                <value><?php echo htmlspecialchars($animal['current_location'] ?? ''); ?></value>
            </div>
            <?php endif; ?>
            <?php if (!empty($animal['mother_tag'])): ?>
            <div class="info-item">
                <label>Mother</label>
            ...
            <div class="info-item">
                ...
                <value><?php echo formatCurrency($animal['purchase_cost'] ?? 0); ?></value>
            </div>
            <?php endif; ?>
        </div>
    ...
    <?php if (count($healthRecords) > 0): ?>
        ...
        <div class="record-card">
            ...
            <p><strong>Cost:</strong> <?php echo formatCurrency($record['cost'] ?? 0); ?></p>
            <?php endif; ?>
    ...
    <?php if (count($productionRecords) > 0): ?>
        ...
        foreach ($productionRecords as $record): 
            $totalProduction += ($record['quantity'] ?? 0);
        ?>
        <div class="record-card">
            <h4><?php echo formatDate($record['date'] ?? ''); ?></h4>
            <p><strong>Type:</strong> <?php echo ucfirst($record['type'] ?? ''); ?></p>
            <p><strong>Quantity:</strong> <?php echo number_format($record['quantity'] ?? 0, 2); ?> <?php echo $record['unit'] ?? ''; ?></p>
            <?php if (!empty($record['morning'])): ?>
            <p><strong>Morning:</strong> <?php echo number_format($record['morning'] ?? 0, 2); ?> <?php echo $record['unit'] ?? ''; ?></p>
            <?php endif; ?>
            <?php if (!empty($record['evening'])): ?>
            <p><strong>Evening:</strong> <?php echo number_format($record['evening'] ?? 0, 2); ?> <?php echo $record['unit'] ?? ''; ?></p>
            <?php endif; ?>
            <?php if (!empty($record['notes'])): ?>
            <p><strong>Notes:</strong> <?php echo htmlspecialchars($record['notes'] ?? ''); ?></p>
            <?php endif; ?>
    ...
    <?php if (count($breedingRecords) > 0): ?>
        ...
        <div class="record-card">
            ...
            <p><strong>Offspring:</strong> <?php echo $record['offspring_count'] ?? 0; ?></p>
            <?php endif; ?>
            <?php if (!empty($record['notes'])): ?>
            <p><strong>Notes:</strong> <?php echo htmlspecialchars($record['notes'] ?? ''); ?></p>
            <?php endif; ?>
    ...
    <?php if (count($expenses) > 0): ?>
        ...
        <div class="record-card">
            ...
            <p><strong>Amount:</strong> <?php echo formatCurrency($expense['amount'] ?? 0); ?></p>
